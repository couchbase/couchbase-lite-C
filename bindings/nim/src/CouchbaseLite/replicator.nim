...
proc stop*(repl: Replicator) =
    ...
    ## The replicator will call your ChangeListener with an activity level of
    ## ``Stopped`` after it stops. Until then, consider it still active.
    throw ErrorCode.Unimplemented
...
proc addChangeListener*(repl: Replicator, listener: ChangeListener): ListenerToken =
