...
* [Contributor guidelines](https://github.com/couchbaselabs/couchbase-lite-C/wiki/Contributor-Guidelines), should you wish to submit bug fixes, tests, or other improvements
